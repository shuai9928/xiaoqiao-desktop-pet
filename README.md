...
**浏览这份发布介绍：** [动作与立体感](#motion) · [18 张表情](#expressions) · [完整菜单](#menus) · [聊天与快捷互动](#chat) · [专注与陪伴](#companion) · [设置与托盘](#settings) · [开始使用](#start)
...
<img src="docs/media/interaction-card.jpg" alt="隔离测试时的互动卡片截图：陪伴天数、星光进度，以及聊天、喂糖、时间魔法、跳舞、玩球、睡觉六个按钮。" width="242"><br>
<sub>互动卡片截图 · 展示用状态</sub>
</td>
</tr>
</table>
...
<sub>演示说明：上方三个循环动画由当前公开源码在隔离环境中按固定时间步绘制；背景与标题为展示排版，并非桌面录像。互动卡片图片沿用此前隔离测试截图，窗口外观可能随版本和系统有所不同。未调用真实 AI，未使用个人聊天记录。动画不代表设备的实时帧率；不便播放时可查看 <a href="docs/GALLERY.md">静态图与演示说明</a>。</sub>
